...
import { logStructured, config, isExpressionReference, reportInteraction } from '@grafana/runtime';
...
export class PanelDataPaneNext extends SceneObjectBase<PanelDataPaneNextState> {
  ...
  private async loadDatasource(resolvedRef?: DataSourceRef) {
    ...
    try {
      ...
      logStructured('features.dashboard-scene', 'error', 'Failed to load datasource:', err);
      ...
      try {
        ...
        logStructured('features.dashboard-scene', 'error', 'Failed to load default datasource:', fallbackErr);
        this.setState({
