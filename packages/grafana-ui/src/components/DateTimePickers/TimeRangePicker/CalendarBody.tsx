...
import { writeStructuredLog, type GrafanaTheme2, dateTimeParse, type DateTime, type TimeZone } from '@grafana/data';
  ...
  return useCallback<NonNullable<React.ComponentProps<typeof Calendar>['onChange']>>(
    (value) => {
      if (!Array.isArray(value)) {
        return writeStructuredLog('grafana-ui', 'error', 'onCalendarChange: should be run in selectRange={true}');
      }
